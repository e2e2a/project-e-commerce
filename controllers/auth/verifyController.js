                ...
                if (verificationCode === userToken.verificationCode) {
                    if (userToken.expirationCodeDate > new Date()) {
                        ...
                        <div style="background-color: #e8f5e9; padding: 20px; width: 100%; text-align: justify; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                            <h3 style="color: #333; margin-bottom: 20px;"><a href="http://dunamismusiccenter.onrender.com" style="color: #007bff; text-decoration: none;">Dunamismusiccenter.onrender.com</a></h3>
                            <h4 style="color: #333;">Greetings, ${user.fullname}!</h4>
        ...
        try {
            ...
            if (userToken) {
                ...
                if (verificationToken === userToken.token) {
                    ...
                    // link
                    const verificationLink = `http://dunamismusiccenter.onrender.com/verify?token=${verificationToken}`;
                    const emailContent = `
                    <div style="background-color: #e8f5e9; padding: 20px; width: 100%; text-align: justify; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                        <h3 style="color: #333;margin-bottom: 20px;"><a href="http://dunamismusiccenter.onrender.com" style="color: #007bff; text-decoration: none;">Dunamismusiccenter.onrender.com</a></h3>
                        <h4 style="color: #333;">Greetings, ${user.fullname}!</h4>
